            ...
            try
            {
                ...
                while (tracinhos.isComTracinhosAinda () && !controladorDeErros.isMaximoDeErrosAtingido ())
                {
                    ...
                    else
                    {
                        ...
                        int qtd = palavra.getQuantidadeDessaLetra (letra);
                        ...
                        {
                            for (int i=0; i<qtd; i++)
                                tracinhos.desvele (palavra.getPosicaoOcorrenciaDessaLetra (i,letra), letra);
                            System.out.println ();
                        }
                    }
                }

                if (controladorDeErros.isMaximoDeErrosAtingido ())
